...
| --- | --- | --- | --- | --- | --- |
| 2026-02-11 | `TBD (pending commit)` | Pane view service extraction + theme boundary migration | `just check`; `just arch-check`; `bun run test:unit` | Pass | Import-boundary violations reduced from 1 to 0 and baseline refreshed. |
