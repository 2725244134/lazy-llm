...
const ROSE_PINE_MAIN_SIDEBAR_VARS = {
  ...
  '--select-open-ring': 'rgba(215, 130, 126, 0.22)',
  '--select-item-hover-bg': 'rgba(215, 130, 126, 0.12)',
  '--select-item-selected-bg': 'rgba(215, 130, 126, 0.18)',
  '--input-scrollbar-thumb': 'rgba(215, 130, 126, 0.42)',
  '--input-scrollbar-thumb-hover': 'rgba(215, 130, 126, 0.56)',
  '--input-scrollbar-thumb-focus': 'rgba(215, 130, 126, 0.72)',
  '--input-border-hover': '#d99a96',
  '--input-focus-ring': 'rgba(215, 130, 126, 0.24)',
  '--input-focus-shadow': 'rgba(215, 130, 126, 0.14)',
...
const ROSE_PINE_MAIN_QUICK_PROMPT_VARS = {
  ...
  '--qp-border': '#d7dce6',
  '--qp-border-focus': '#d7827e',
  '--qp-ring': 'rgba(215, 130, 126, 0.2)',
  '--qp-inner-stroke': 'rgba(255, 255, 255, 0.88)',
  '--qp-text': '#1f2937',
  '--qp-placeholder': '#6b7280',
  '--qp-shadow': '0 12px 24px rgba(15, 23, 42, 0.12)',
  '--qp-shadow-focus': '0 16px 30px rgba(215, 130, 126, 0.24)',
  '--qp-inset-top': 'rgba(255, 255, 255, 0.82)',
  '--qp-inset-bottom': 'rgba(215, 130, 126, 0.18)',
  '--qp-inset-top-focus': 'rgba(255, 255, 255, 0.9)',
  '--qp-inset-bottom-focus': 'rgba(215, 130, 126, 0.28)',
  '--qp-scrollbar-thumb': 'rgba(215, 130, 126, 0.44)',
  '--qp-scrollbar-thumb-hover': 'rgba(215, 130, 126, 0.62)',
} as const satisfies CssVariableMap;
